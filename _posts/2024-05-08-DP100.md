...
- [Overview](#designing-a-data-ingestion-solution)
  - Data Ingestion Solution
  - Development Approaches - CLI, Python, Studio, Git, Environment (Code)
  - Azure ML workspace (Code: creation of Workspace using Python and SDK)
  - Resources and Assets
- [Design and Prepare ML Solution](#i-design-and-prepare-a-machine-learning-solution)
  - Compute and its types
  - Create compute targets using Python SDK and CLI (Code)
  - LAB 1: Create Azure ML Workspace
- [Explore Data and Train Model](#ii-explore-data-and-train-model)
  - Terminologies: URI, Datastore, Data Asset (Code: creation of datastore and data asset using python)
  - Preprocessing of data 
  - Feature selection and engineering
  - Differential Privacy (Responsible AI)
  - Code: Accessing data during interactive development (Data Wrangling)
  - LAB 2: Wrangle data with Python in Azure ML
- [Three ways to build and train ML model](#iii-three-ways-to-build-and-train-ml-model)
  - Using Azure ML designer
    - LAB 3: Create basic pipeline in azure ml studio
  - Using azure automated ML
  - Using python SDK
- [Tuning hyperparameters in Azure ML](#tuning-hyperparameters-in-azure-machine-learning)
  - Hyperparameters
  - Sampling methods
  - Early termination policies
- [Pipelines, Components, MLflow](#run-training-script-as-command-job-in-azure-ml)
 -->
...
- [Pipelines and MLflow](#run-training-script-as-command-job-in-azure-ml)
