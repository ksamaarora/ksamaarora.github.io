...
Three ways to interact with Azure Machine Learning
  - **Azure CLI:** Use this command-line approach for automation of infrastructure. Following command is used to define an compute resource and then create a Azure ML Workspace
    - ```python
      ...
      ```
  - **Python SDK:** Used to submit jobs and manage models from a Jupyter notebook, ideal for data scientists
  - **Azure ML Studio:** Use the user-friendly UI to explore workspace and other capabilities - low code training and development, data management and monitoring can be applied
...
**Note:** **Azure CLI, Azure ML studio, and Azure Machine Learning SDK for Python** are all commonly used in at least one phase of building, training, and deploying models in Azure Machine Learning. 
