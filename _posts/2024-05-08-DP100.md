...
- When using Azure Machine Learning, Azure Databricks, or Azure Synapse Analytics for model training, three common options for storing data are:
  ...
  - **Azure Data Lake Storage (Gen 2):** Best for **storing large volumes (limitless) of unstructured data** like CSV files and images. A data lake also implements a hierarchical namespace, which means it’s **easier** to give **someone access** to a **specific file or folder**. 
