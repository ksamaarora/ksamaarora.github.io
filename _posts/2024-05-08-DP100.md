...
- **Datastores:** It is how we securely connect to data in our Azure Storage
- **Datasets:** It is how we get specific files in our datastore
...
- **Feature Engineering:** The process of **selecting and expressing data** in a way that improves the performance of machine learning models. 
    - **Wrapper method:** We try all **combinations** and **pick the best** one. Prone to overfitting
    - **Filter method:** This method is **relationship based**. We apply **statistical techniques**.  Faster than wrapper method. 
