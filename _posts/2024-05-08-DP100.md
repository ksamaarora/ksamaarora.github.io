...
- [Explore Data and Train Model](#explore-data-and-train-model)
...
- [Three ways to build and train ML model](#three-ways-to-build-and-train-ml-model)
...
- [Pipelines, Compoenents, MLflow](#Run-training-Script-as-Command-Job-in-Azure-Ml-*)
