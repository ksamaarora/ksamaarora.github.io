...
- **Text Analytics:** includes **language detection**, **sentiment analysis** - if text +ve (1) or -ve (0), **extract key phrases** (to summarize doc or find key talking points), **entity recognition** (return list of entities, categories assigned to, confidence score)
- **Speech Detection**
