...
| Split data module             | Will split into training and validation datasets  |
...
- **Speech recognition** - ability to detect and interpret spoken input - convert **speech into text** 
...
- **Azure AI Language:** **used to create knowledge database of qs ans** - enter manually, or import FAQ or chit-chat data - then publish so that Azure bot service can deliver to end users - can be interacted **via REST API, software development kit, and Language studio**
