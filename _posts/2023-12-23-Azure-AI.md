...
**Azure Services:** Azure AI Language and Azure Bot Service

- **Azure AI Language:** Create knowledge base of qs and ans - by either entering manually or import from chit-chat data source, FAQ - can publish database and Azure Bot service can deliver it to end users 

- **Azure Bot Service:** How we can deliver knowledge base to end users - create interface via web email, Teams, slack etc - created via Bot Framework SDK or in the Language Stusio for Cognitive Services for Language 
